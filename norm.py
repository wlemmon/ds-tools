...
def lognormpdf_fast_1D(x1, x2, sigma_sq_times_2, log_sqrt_twoPi_sigmaSq):
    distSq = (x2 - x1) ** 2
    return - distSq / sigma_sq_times_2 - log_sqrt_twoPi_sigmaSq

def lognormpdf_fast_1D_dist(dist, sigma_sq_times_2, log_sqrt_twoPi_sigmaSq):
    distSq = dist ** 2
    return - distSq / sigma_sq_times_2 - log_sqrt_twoPi_sigmaSq
"""
normpdf_fast
...
if __name__ == '__main__':
    ...
    assert np.allclose(_lognormpdf(1., 2., 3.), np.log( _normpdf(1., 2., 3.)))
